...
function overviewElementCreate(){
    ...
    .append('<div id="overview" style="height:100%"><div id="overviewTop"></div><div id="overviewCenter"><div class ="overviewCenter" id="overviewCenterLeft"><div id="todayLogin"></div><div id="divider"></div><div id="topTenLogin"></div></div><div class ="overviewCenter" id="overviewCenterCenter"></div><div class ="overviewCenter" id="overviewCenterRight"><div id="overviewDatebtn" style="display:none;"><label style="margin-right: 5px;"><b>Date Range</b></label><button class="overviewDate jqueryUIButton">Date</button><div id="overviewDateDropdown" class="selector"><div id="overviewTimeSection"><button class="btn_unpressed" id="overviewBtnToday">Today</button><button class="btn_unpressed" id="overviewBtnYesterday">Yesterday</button><button class="btn_unpressed" id="overviewBtnLastSeven">Last 7 Days</button><button class="btn_unpressed" id="overviewBtnLastThirty">Last 30 Days</button><button class="btn_unpressed" id="overviewBtnThisMonth">This Month</button><button class="btn_unpressed" id="overviewBtnLastMonth">Last Month</button></div><p style="margin-left:3%"><b>Custom date range</b></p><div><input value="From Time" type="text" id="overviewFrom" name="from" >-<input value="To Time" type="text" id="overviewTo" name="to"></div><div style="display: block;"><button class="overviewSubmit jqueryUIButton">Apply</button></div></div></div></div></div></div>');
...
function overviewDateBtnTextUpdate(){
    ...
    //console.log(from);
    var text =  (from.getFullYear() + "-" + (from.getMonth() + 1) + "-" + from.getDate()) 
                + '~' 
...
function overviewInitTop(json){
    ...
    $('#overviewTop')
        .html('<b>Total user count:</b> '+allUserCount+'　　'
               +'<b>Total consultation count:</b> '+allConsultationCount+'　　'
               +'<b>Average consultation count per user:</b> '+consultationPerEachUser);
}
...
function overviewInitCenterCenter(json){
    ...
    jQuery('<label/>',{class:'overviewTitle'})
...
function overviewInitCenterRight(json){
    ...
    var title = jQuery('<div/>',{class:'centerRightTitle'}).css('height','10%').appendTo(container);
    ...
    var selector = jQuery('<select/>',{id:'overviewTimePeriodSelect'}).appendTo(title);
